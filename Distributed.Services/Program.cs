...
builder.Services.AddDbContext<MainContext>(opts =>
    opts.UseMySql("server=bpmaxpmeyqknmkluwzyf-mysql.services.clever-cloud.com; database=bpmaxpmeyqknmkluwzyf; uid=u0bwnnuczatwwvyj; password=g8AJujptIxIywW3lRUsr; port=3306", 
    new MySqlServerVersion(new Version()), b => b.MigrationsAssembly("Distributed.Services")));
